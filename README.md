...
- 🔭 Currently working on **Data Science & AI projects**, including:
...
Here are some highlighted areas from my GitHub repositories:

- 🔹 **LLM & Generative AI Projects**
  - LLM-based applications
  - RAG pipelines with vector search and evaluation
- 🔹 **Machine Learning Projects**
  - End-to-end ML workflows (EDA → Modeling → Evaluation)
...
- 💼 LinkedIn: https://www.linkedin.com/in/menna-elsayed-859b7628a/
- ✍️ Medium: https://medium.com/@manon.mustafa.325
